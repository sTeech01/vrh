...
const ERP_MODULES = [
  ...
  {
    id: 'installation', label: 'Монтаж', subLabel: 'Управление монтажом',
    active: false,
    icon: _platModIcon('<path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>'),
  },
  {
    id: 'service', label: 'Сервис', subLabel: 'Техническое обслуживание',
    active: false,
    icon: _platModIcon('<polyline points="23 4 23 10 17 10"/><polyline points="1 20 1 14 7 14"/><path d="M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"/>'),
  },
  {
