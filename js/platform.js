...
const ERP_MODULES = [
  ...
  {
    id: 'erp-projects', label: 'Проекты', subLabel: 'Активные проекты',
    active: true, hash: 'erp-projects',
  ...
  {
    id: 'tasks', label: 'Задачи', subLabel: 'Контроль сотрудников',
    active: true, hash: 'tasks',
  ...
  },
  {
    ...
    active: true, hash: 'assignees',
    icon: _platModIcon('<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/>'),
  },
];
...
function updatePlatformSidebar(view) {
  ...
  if (view === 'home') {
  ...
  else if (view === 'erp-projects') {
    html = `
      ${_PLAT_BACK_BTN}
      <div class="sidebar-section">Проекты</div>
      <a class="nav-item" data-nav="erp-projects" href="#erp-projects">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
    ...
    html = `
      ${_PLAT_BACK_BTN}
      <div class="sidebar-section">Задачи</div>
      <a class="nav-item" data-nav="tasks" href="#tasks">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
      ...
      <a class="nav-item" data-nav="task-report" href="#task-report">
        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="18" height="18">
