...
const VRH_ITEMS = [
...

  {
    ...
    components: [],
    history: [
      { date: '2026-06-19', text: 'Конуса изготовлены на складе. Ждём приезда труб и профилей для сборки. Шары изготовлены.' },
    ],
    notes: 'Конуса на складе. Ждём трубы и профили для сборки.',
  },
...

  {
    ...
    deadline: '2026-08-03', type: 'own',
    doneCount: 0, materialsStatus: PUR.RECEIVED,
    components: [],
    history: [
      { date: '2026-06-02', text: 'Всё упаковано, кроме полосы — нет полосы (ждём).' },
      { date: '2026-04-30', text: '22 готовы. Пластины крепления к стене готовы 50%.' },
    ],
    notes: 'Дегазаторы упакованы. Ждём полосы для окончательной комплектации.',
  },
...

  {
    ...
    deadline: '2026-09-03', type: 'purchased',
...

  {
    ...
    deadline: '2026-09-05', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-08-06', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },

  {
    ...
    deadline: '2026-09-07', type: 'purchased',
...

  {
    ...
    deadline: '2026-07-24', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },

  {
    ...
    deadline: '2026-08-24', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-07-26', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },

  {
    ...
    deadline: '2026-08-26', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    components: [],
    history: [
      { date: '2026-06-12', text: 'Полоса установлена.' },
...

  {
    ...
    deadline: '2026-08-29', type: 'purchased',
    purchaseStatus: PUR.ORDERED, doneCount: 0,
    history: [
...

  {
    ...
    deadline: '2026-08-27', type: 'purchased',
    purchaseStatus: PUR.ORDERED, doneCount: 0,
    history: [
      { date: '2026-03-17', text: 'Оплачен.' },
    ],
...

  {
    ...
    deadline: '2026-07-29', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Богдана.',
  },
...

  {
    ...
    deadline: '2026-07-30', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
...

  {
    ...
    deadline: '2026-08-31', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-08-08', type: 'purchased',
    purchaseStatus: PUR.ORDERED, doneCount: 0,
    history: [
      { date: '2026-03-30', text: 'Оплачен.' },
    ],
...

  {
    ...
    deadline: '2026-09-08', type: 'purchased',
    purchaseStatus: PUR.ORDERED, doneCount: 0,
    history: [
...

  {
    ...
    deadline: '2026-08-09', type: 'purchased',
    purchaseStatus: PUR.ORDERED, doneCount: 0,
    history: [
...

  {
    ...
    deadline: '2026-09-10', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-08-11', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },

  {
    ...
    deadline: '2026-09-12', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-08-12', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
...

  {
    ...
    deadline: '2026-08-14', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },

  {
    ...
    deadline: '2026-09-15', type: 'purchased',
    purchaseStatus: PUR.PENDING, doneCount: 0, history: [],
    notes: 'Ждём Максима.',
  },
